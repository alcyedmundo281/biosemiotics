...
abstract: >
  ...
  una propiedad del paciente que tienes delante. Un número tiene tres fuentes de
  error acumuladas: la medición, el corte elegido y la población de donde se
  derivó. Este concepto reúne los ejemplos que el atlas ya usó —los 6 mm del
  apéndice, el colédoco, la fracción de eyección a ojo— para enseñar a leer
  cualquier cifra con la desconfianza correcta.

dominio: semiotica
nivel: intermedio
capitulo: 6
orden: 4
tags: [cuantificacion, umbral, medicion, variabilidad, poblacion, incertidumbre]
relacionado_con: [doppler, modo-m, ecogenicidad, knobology-ganancia]
prerequisito_de: []
