...
abstract: >
  ...
  responde una sola pregunta binaria —¿hay líquido libre?—. Cada ventana ya
  tiene su ficha propia; este nodo enseña la secuencia, el orden y la decisión
  que las une. Su valor está en el paciente inestable, donde un hallazgo
  positivo manda al quirófano sin escala; no está pensado para cuantificar
  sangrado ni para evaluar lesión de órgano.

dominio: tecnica
nivel: intermedio
capitulo: 4
orden: 5
tags: [fast, efast, trauma, liquido-libre, protocolo, secuencia]
relacionado_con: [signo-fast-morrison, signo-fast-esplenorrenal, signo-fast-douglas, signo-derrame-pericardico, signo-neumotorax, signo-hemotorax, tipos-de-sonda, ventanas-cardiacas]
prerequisito_de: []
