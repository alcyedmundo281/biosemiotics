...
abstract: >
  Espacios anecoicos comunicados que dilatan la pelvis y los cálices renales
  señalan hidronefrosis, un hallazgo indirecto de drenaje urinario alterado.
  En el cólico renal orienta obstrucción y ayuda a decidir quién necesita
  imagen adicional o valoración urológica, pero no localiza ni demuestra por
  sí solo un cálculo. Pelvis extrarrenal, quistes parapélvicos, vasos y vejiga
  llena pueden imitarla; una ecografía negativa no excluye obstrucción temprana.

sistema: genitourinario
organo: riñon
nivel: principiante
ventana: flanco-posterior
sonda: [convexa]
pregunta_clinica: "¿El sistema colector renal está dilatado y sugiere obstrucción?"
escenario: [urgencias]
descriptores: [hidronefrosis, litiasis-ureteral, colico-renal, obstruccion, pocus]
mesh: [Hydronephrosis, Ureterolithiasis, Kidney, Ultrasonography, Point-of-Care Systems]

significante: "Área anecoica central ramificada y comunicada que separa o dilata pelvis y cálices renales."
significado: "Dilatación del sistema colector; puede acompañar obstrucción urinaria, pero no identifica por sí sola su causa."
decision: "Integra el grado de dilatación con dolor, función renal, infección y factores de riesgo; deriva o completa imagen cuando el resultado cambia una conducta o la sospecha persiste."
umbral: >
  La ficha usa una lectura cualitativa: ausente, leve o marcada. No convierte un
  diámetro aislado en diagnóstico. Deben revisarse ambos riñones en planos
  longitudinal y transversal y, cuando sea posible, la vejiga.
falsos_positivos:
  - "Pelvis extrarrenal: área anecoica central sin dilatación calicial"
  - "Quistes parapélvicos: espacios redondeados que no se comunican entre sí"
  - "Vasos renales prominentes: confírmarlos con Doppler cuando esté disponible"
  - "Vejiga muy llena o diuresis intensa con dilatación fisiológica transitoria"
  - "Embarazo, especialmente con dilatación fisiológica del lado derecho"
se_basa_en: [ecogenicidad, artefacto-refuerzo-posterior, tipos-de-sonda]
contrasta_con: [signo-riñon-cronico]
...
- **POCUS no ve necesariamente el cálculo.** La hidronefrosis es una consecuencia,
  no una etiología.
- **Un estudio negativo no excluye obstrucción temprana.** Si la clínica no
  concuerda, completa la evaluación.
- **Pelvis extrarrenal y quistes parapélvicos imitan dilatación.** Busca cálices
  comunicados y confirma en dos planos.
- **Los vasos también son negros.** Su trayecto y el Doppler ayudan a separarlos
  del sistema colector.
- **La vejiga llena altera la lectura.** Interpreta riñones y vejiga como un solo
  recorrido.
- **No uses la ecografía aislada en un paciente de alto riesgo.** Infección,
