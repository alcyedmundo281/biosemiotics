...
abstract: >
  Un foco ecogénico dentro de la vesícula, móvil con los cambios de posición y
  acompañado por sombra acústica posterior, identifica un cálculo biliar. El
  hallazgo orienta el dolor en hipocondrio derecho, pero no demuestra por sí
  solo colecistitis ni explica todo dolor abdominal. Barro, pólipos, pliegues,
  gas y sombras de borde pueden imitarlo; una exploración negativa o incompleta
  no cierra una sospecha clínica persistente.
...
sonda: [convexa]
pregunta_clinica: "¿Hay un cálculo dentro de la vesícula que pueda explicar el dolor?"
escenario: [urgencias, consulta]
descriptores: [colelitiasis, calculo-biliar, vesicula, sombra-acustica, pocus]
mesh: [Cholelithiasis, Gallbladder, Ultrasonography, Point-of-Care Systems]
...
decision: "Integra el hallazgo con la clínica; si solo hay cálculo sin signos inflamatorios, no lo llames colecistitis. Solicita evaluación completa si persiste la sospecha o aparecen datos de complicación."
umbral: >
  No hay un diámetro único que defina el signo. La combinación práctica es
  localización intravesicular, movilidad o dependencia y sombra posterior; los
  cálculos pequeños pueden no producir una sombra visible.
falsos_positivos:
  - "Pólipo vesicular adherido a la pared: no cambia de posición y habitualmente no produce sombra"
  - "Barro biliar o barro tumefactivo: ecos de bajo nivel, dependientes, sin sombra limpia"
  - "Pliegue del cuello vesicular o válvula de Heister"
...
contrasta_con: [signo-colecistitis-aguda, signo-coledocolitiasis]
