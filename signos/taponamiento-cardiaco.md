...
organo: pericardio
nivel: intermedio
ventana: subcostal-paraesternal-apical-vci
sonda: [sectorial]
pregunta_clinica: "¿Este derrame pericárdico está comprometiendo el llenado del corazón ahora mismo?"
escenario: [urgencias, hospitalizacion, uci]
descriptores: [taponamiento-cardiaco, pericardio, colapso-cavidades, vena-cava-inferior, focus]
mesh: [Cardiac Tamponade, Echocardiography, Point-of-Care Systems]
...
umbral: >
  ...
  serie; el de la aurícula derecha, sensibilidad entre 50 % y 100 % y
  especificidad entre 33 % y 100 %. Son más confiables cuando la probabilidad
