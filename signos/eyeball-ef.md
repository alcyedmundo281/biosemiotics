...
abstract: >
  Cambio global del tamaño de la cavidad ventricular izquierda acompañado por
  engrosamiento y desplazamiento endocárdico durante la sístole, valorado en
  varias vistas y ciclos. Permite clasificar la función como claramente
  deprimida, no claramente deprimida o hiperdinámica para orientar el shock.
  No reemplaza una fracción de eyección cuantitativa: mala ventana,
  acortamiento apical, arritmia y alteraciones segmentarias reducen su fiabilidad.

sistema: cardiovascular
organo: corazon
nivel: principiante
ventana: paraesternal-apical
sonda: [sectorial]
pregunta_clinica: "¿La función sistólica global del ventrículo izquierdo está claramente deprimida, conservada o hiperdinámica?"
escenario: [urgencias, hospitalizacion, uci]
descriptores: [funcion-sistolica, ventriculo-izquierdo, fraccion-eyeccion, focus]
mesh: [Ventricular Function, Left, Echocardiography, Point-of-Care Systems]

significante: "Cambio global del tamaño de la cavidad del VI, engrosamiento miocárdico y desplazamiento endocárdico durante la sístole, observado en varias vistas y ciclos."
significado: "Categoría cualitativa de función sistólica global del ventrículo izquierdo."
decision: "Reconocer disfunción sistólica global marcada o un patrón hiperdinámico e integrarlo con perfusión, precarga, poscarga, válvulas y ventrículo derecho antes de decidir tratamiento."
umbral: >
  Eyeball EF es una clasificación cualitativa, no una medición. No debe
  asignarse un porcentaje exacto ni usarse una sola vista o un solo latido para
  cruzar umbrales terapéuticos.
falsos_positivos:
  - "Vista apical acortada que exagera la contracción"
  - "Alteración segmentaria que no representa la función global"
  - "Taquicardia, fibrilación auricular o extrasístoles"
  - "Cambios de precarga o poscarga que modifican la apariencia"
  - "Mala definición endocárdica por ventana, ganancia o profundidad"
  - "Sobrecarga del ventrículo derecho con desplazamiento septal"
se_basa_en: [ventanas-cardiacas, tipos-de-sonda, knobology-profundidad, knobology-ganancia]
contrasta_con: []
