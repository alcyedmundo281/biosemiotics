...
abstract: >
  Estructura pélvica media, anecoica y distendida detrás de la sínfisis púbica,
  confirmada en planos transversal y longitudinal. En un paciente que no puede
  orinar, apoya retención urinaria y permite estimar volumen antes de sondar.
  La medición es aproximada y no existe un umbral universal: ascitis, quistes
  pélvicos, útero, contenido vesical y geometría irregular pueden alterar la
  lectura.
...
ventana: suprapubica
sonda: [convexa]
pregunta_clinica: "¿La vejiga está realmente distendida y la retención explica los síntomas o la oliguria?"
escenario: [urgencias, consulta, hospitalizacion, preoperatorio]
descriptores: [retencion-urinaria, vejiga, volumen-vesical, sondaje]
mesh: [Urinary Retention, Urinary Bladder, Ultrasonography, Urinary Catheterization]

significante: "Estructura anecoica distendida en la línea media pélvica, posterior a la sínfisis púbica, confirmada en eje transversal y longitudinal."
significado: "Vejiga llena; en el contexto de incapacidad para orinar, hallazgo compatible con retención urinaria."
decision: "Si la vejiga está distendida y el contexto confirma retención, descomprimir cuando esté indicado y buscar la causa; si contiene poco volumen, evitar un sondaje reflejo y reevaluar oliguria o anuria."
umbral: >
  No existe un volumen único que defina toda retención aguda o crónica. La
  medición ecográfica es aproximada y debe interpretarse con síntomas, tiempo
  desde la última micción, función renal, anatomía y protocolo local.
falsos_positivos:
  - "Ascitis o líquido pélvico libre"
  - "Quiste ovárico o masa quística pélvica"
  - "Útero gestante o aumentado de tamaño"
  - "Asa intestinal con contenido líquido"
  - "Coágulos, sedimento o sonda dentro de la vejiga"
  - "Geometría irregular o compresión por recto, útero o masa"
se_basa_en: [ecogenicidad, artefacto-refuerzo-posterior, tipos-de-sonda, knobology-profundidad]
contrasta_con: []
...
- **Útero:** embarazo, miomas o aumento uterino modifican la forma y el cálculo.
- **Contenido complejo:** coágulos, sedimento o aire vuelven la vejiga menos
  anecoica.
- **Borde incompleto:** cortar el domo subestima el volumen.
- **Cálculo rígido:** distintos métodos pueden producir errores grandes; no
  bases una decisión compleja en un número aislado.
