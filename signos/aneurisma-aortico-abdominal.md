---
id: signo-aneurisma-aortico-abdominal
tipo: signo
...
abstract: >
  Una aorta abdominal con diámetro máximo mayor de 3,0 cm, medido de borde
  externo a borde externo, cumple el criterio ecográfico de aneurisma. En dolor,
  síncope o shock, reconocerla acelera activación vascular y traslado, pero
  POCUS demuestra el aneurisma, no la ruptura. Medición oblicua, trombo mural,
  vena cava, masas paraaórticas y un segmento distal no visualizado pueden
  producir errores; un examen incompleto nunca descarta la emergencia.

sistema: vascular
organo: aorta-abdominal
nivel: principiante
ventana: transabdominal
sonda: [convexa, sectorial]
pregunta_clinica: "¿La aorta abdominal mide más de 3,0 cm y cambia la prioridad del paciente?"
escenario: [urgencias]
descriptores: [aneurisma-aortico-abdominal, aorta, dolor-abdominal, shock, pocus]
mesh: [Aortic Aneurysm Abdominal, Aorta Abdominal, Ultrasonography, Point-of-Care Systems]

significante: "Dilatación de la aorta abdominal con diámetro máximo mayor de 3,0 cm, medido perpendicular al eje vascular de borde externo a borde externo."
significado: "Aneurisma aórtico abdominal."
decision: "En un paciente sintomático o inestable, activa de inmediato la ruta de emergencia vascular y la imagen definitiva o traslado sin permitir que POCUS retrase la reanimación."
umbral: >
  Diámetro máximo > 3,0 cm de borde externo a borde externo. Recorre aorta
  proximal, media y distal hasta la bifurcación; mide en un plano perpendicular
  al vaso e incluye el trombo mural dentro del diámetro total.
falsos_positivos:
  - "Medición oblicua de una aorta tortuosa que exagera el diámetro"
  - "Medir solo la luz y excluir el trombo mural, subestimando el aneurisma"
  - "Confundir la vena cava inferior con la aorta"
  - "Masa o ganglio paraaórtico"
  - "No visualizar la aorta distal por gas y declarar un estudio negativo"
